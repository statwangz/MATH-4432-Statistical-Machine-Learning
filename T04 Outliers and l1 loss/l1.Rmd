...
.footnote[
[*] Materials are from [Subgradients](https://see.stanford.edu/materials/lsocoee364b/01-subgradients_notes.pdf) and [Subgradient Methods](https://web.stanford.edu/class/ee392o/subgrad_method.pdf), Stephen Boyd and Lieven Vandenberghe, EE364b, Stanford University.
]
...
beta <- c(beta_0 = -3, beta_1 = 1) # Initialize
...
for (k in 1:iter_max) {
  ...
  subgrad <- colSums(X * sign(r)) # Subgradients
