...
**I recommend you do homework assignments via a single R Markdown file, in which you can include your solutions, output the report, and then submit it on Canvas!**
...
```{r panelset = c(source = "Base-R", output = "Plot"),fig.align='center',out.width="50%"}
set.seed(123)
...
```{r panelset = c(source = "ggplot2", output = "Plot"),fig.align='center',out.width="50%"}
