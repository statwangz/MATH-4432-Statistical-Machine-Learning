...
- As $\lambda \rightarrow \infty$ the penalty has more influence the penalized least squares functional So, for very large values of $\lambda$, the function estimate $f_\lambda$ is essentially constrained to have a zero penalty, i.e., $J_m\left(f_\lambda\right) \approx 0$.
